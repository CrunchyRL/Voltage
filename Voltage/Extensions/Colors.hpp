...
public:
	...
	CRColor(const CRColor& other);
	CRColor(const struct FColor& other);
	~CRColor();
...
public:
	CRColor operator=(const CRColor& other);
	CRColor operator=(const struct FColor& other);
	bool operator==(const CRColor& other);
...
public:
	...
	CRLinearColor(const CRLinearColor& other);
	CRLinearColor(const struct FLinearColor& other);
	~CRLinearColor();
...
public:
	CRLinearColor operator=(const CRLinearColor& other);
	CRLinearColor operator=(const struct FLinearColor& other);
	bool operator==(const CRLinearColor& other);
...
{
private:
	static inline CRColor ByteRainbow = { 0, 0, 255, 255 };
	static inline CRLinearColor LinearRainbow = { 0, 0, 255, 255 };

public:
	static CRColor GetByte();
	static CRLinearColor GetLinear();
	static void Tick();
};
