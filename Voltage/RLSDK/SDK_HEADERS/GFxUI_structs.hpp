...
struct FLoadingMovieMapInfo
{
	...
	struct FString                                     MapBaseName;                                      		// 0x0008 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FString                                     PlaylistName;                                     		// 0x0018 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FString                                     MapVariantName;                                   		// 0x0028 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FString                                     MaximumPlayerCounts;                              		// 0x0038 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FString                                     ProtipMessage;                                    		// 0x0048 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FString                                     Language;                                         		// 0x0058 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FString                                     BuildEdition;                                     		// 0x0068 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FString                                     ProtipTitle;                                      		// 0x0078 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	unsigned char                                      WeatherVariant;                                   		// 0x0088 (0x0001) [0x0000000000000000]               
