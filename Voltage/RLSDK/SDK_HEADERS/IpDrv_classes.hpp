...
enum class EAdHocDesiredState : int
{
	AHDS_None                                          = 0,
	AHDS_Initialized                                   = 1,
...
enum class EAdHocCurrentState : int
{
	AHCS_None                                          = 0,
	AHCS_Initializing                                  = 1,
	AHCS_Initialized                                   = 2,
...
enum class EOnlineImageDownloadState : int
{
	PIDS_NotStarted                                    = 0,
	PIDS_Downloading                                   = 1,
	PIDS_Succeeded                                     = 2,
...
enum class EMcpChallengeFileStatus : int
{
	MCFS_NotStarted                                    = 0,
	MCFS_Pending                                       = 1,
	MCFS_Success                                       = 2,
...
enum class EMcpFileCompressionType : int
{
	MFCT_NONE                                          = 0,
	MFCT_ZLIB                                          = 1,
	MFCT_END                                           = 2
...
enum class EMcpGroupAccessLevel : int
{
	MGAL_Owner                                         = 0,
	MGAL_Member                                        = 1,
	MGAL_Public                                        = 2,
...
enum class EMcpGroupAcceptState : int
{
	MGAS_Error                                         = 0,
	MGAS_Pending                                       = 1,
	MGAS_Accepted                                      = 2,
...
enum class EMcpMessageCompressionType : int
{
	MMCT_NONE                                          = 0,
	MMCT_LZO                                           = 1,
	MMCT_ZLIB                                          = 2,
...
enum class EMeshBeaconPacketType : int
{
...
enum class EMeshBeaconConnectionResult : int
{
...
enum class EMeshBeaconBandwidthTestState : int
{
...
enum class EMeshBeaconBandwidthTestResult : int
{
...
enum class EMeshBeaconBandwidthTestType : int
{
...
enum class EMeshBeaconClientState : int
{
	MBCS_None                                          = 0,
	MBCS_Connecting                                    = 1,
	MBCS_Connected                                     = 2,
...
enum class EEventUploadType : int
{
	EUT_GenericStats                                   = 0,
	EUT_ProfileData                                    = 1,
...
enum class EReservationPacketType : int
{
...
enum class EPartyBeaconClientRequest : int
{
...
enum class EPartyBeaconClientState : int
{
	PBCS_None                                          = 0,
	PBCS_Connecting                                    = 1,
	PBCS_Connected                                     = 2,
...
enum class EPartyBeaconHostState : int
{
...
enum class ETitleFileFileOp : int
{
	TitleFile_None                                     = 0,
	TitleFile_Save                                     = 1,
	TitleFile_Load                                     = 2,
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_ADHOCDELEGATES));
		}
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_ADHOCERRORS));
		}
...
public:
	...
	unsigned char                                      AvatarSize;                                       		// 0x00B8 (0x0001) [0x0000000000000000]               
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_AVATARDOWNLOAD));
		}
...
public:
	...
	int                                                MaxLocalTalkers;                                  		// 0x0318 (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                MaxRemoteTalkers;                                 		// 0x031C (0x0004) [0x0000000000004000] (CPF_Config)  
...
{
public:
	class UAvatarDownloadMap*                          AvatarDownloadCache;                              		// 0x0070 (0x0008) [0x0000000004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_AVATARDOWNLOADCOMPONENT));
		}
	...
	class UAvatarDownload* GetAvatar(struct FUniqueNetId PlayerID, unsigned char Size);
	void ClearPendingDownloads();
	void CleanupAvatars();
	void DownloadAvatar(struct FUniqueNetId PlayerID, unsigned char Size, struct FString URL);
	void StoreNewAvatars(unsigned char Size, struct FScriptDelegate ReadOnlineAvatarCompleteDelegate, TArray<struct FUniqueNetId>& NewPlayerIDs);
	void ProcessOldRequests(unsigned char SizeType, struct FScriptDelegate ReadOnlineAvatarCompleteDelegate, TArray<struct FUniqueNetId>& InPlayerIDs, TArray<struct FUniqueNetId>& NewRequestIDs);
	bool TryAddAvatarTextureCallback(struct FUniqueNetId PlayerNetId, unsigned char Size, struct FScriptDelegate ReadOnlineAvatarCompleteDelegate);
};
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_AVATARDOWNLOADMAP));
		}
	...
	int CountAvatars();
	void AllValues(int StartIndex, int MaxValues, class UAvatarDownload*& OutAvatar);
};
...
public:
	...
	int                                                ProxyServerPort;                                  		// 0x0AC0 (0x0004) [0x0000000000004000] (CPF_Config)  
	...
	unsigned char                                      UnknownData00[0x124];                             		// 0x0ACC (0x0124) MISSED OFFSET
public:
	static UClass* StaticClass()
	{
		static UClass* uClassPointer = nullptr;
...
public:
	...
	TArray<unsigned char>                              Payload;                                          		// 0x00A0 (0x0010) [0x0000000000001002] (CPF_Const | CPF_Native)
public:
	static UClass* StaticClass()
	{
		static UClass* uClassPointer = nullptr;
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_HTTPREQUESTCURL));
		}
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_HTTPRESPONSECURL));
		}
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_IMAGEDECODER));
		}

		return uClassPointer;
	};

	void RequestDecodeImage(struct FString RequestURL, unsigned char ImageType, struct FScriptDelegate FinishedCallback, TArray<unsigned char>& ImageData);
...
{
public:
	unsigned char                                      LinkMode;                                         		// 0x0268 (0x0001) [0x0000000000000000]               
	unsigned char                                      InLineMode;                                       		// 0x0269 (0x0001) [0x0000000000000000]               
	unsigned char                                      OutLineMode;                                      		// 0x026A (0x0001) [0x0000000000000000]               
	unsigned char                                      ReceiveMode;                                      		// 0x026B (0x0001) [0x0000000000000000]               
	struct FPointer                                    Socket;                                           		// 0x0270 (0x0008) [0x0000000000000002] (CPF_Const)   
	int                                                Port;                                             		// 0x0278 (0x0004) [0x0000000000000002] (CPF_Const)   
	...
	int                                                DataPending;                                      		// 0x0290 (0x0004) [0x0000000000000002] (CPF_Const)   
public:
	static UClass* StaticClass()
	{
		static UClass* uClassPointer = nullptr;
...
{
public:
	unsigned char                                      LinkState;                                        		// 0x0298 (0x0001) [0x0000000000000000]               
	struct FIpAddr                                     RemoteAddr;                                       		// 0x029C (0x0014) [0x0000000000000000]               
	class UClass*                                      AcceptClass;                                      		// 0x02B0 (0x0008) [0x0000000000000000]               
	TArray<unsigned char>                              SendFIFO;                                         		// 0x02B8 (0x0010) [0x0000000000400002] (CPF_Const | CPF_NeedCtorLink)
...
public:
	...
	int                                                DownloadCount;                                    		// 0x0128 (0x0004) [0x0000000000002000] (CPF_Transient)
public:
	static UClass* StaticClass()
	{
		static UClass* uClassPointer = nullptr;
...
public:
	...
	int                                                SocketSendBufferSize;                             		// 0x008C (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                SocketReceiveBufferSize;                          		// 0x0090 (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                MaxBandwidthTestBufferSize;                       		// 0x0094 (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                MinBandwidthTestBufferSize;                       		// 0x0098 (0x0004) [0x0000000000004000] (CPF_Config)  
	...
	int                                                MaxBandwidthHistoryEntries;                       		// 0x00A4 (0x0004) [0x0000000000004000] (CPF_Config)  
public:
	static UClass* StaticClass()
	{
		static UClass* uClassPointer = nullptr;
...
public:
	...
	int                                                ConnectionBacklog;                                		// 0x0114 (0x0004) [0x0000000000004000] (CPF_Config)  
...
public:
	...
	int                                                NextAuthCodeID;                                   		// 0x0078 (0x0004) [0x0000000000002000] (CPF_Transient)
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_ONLINEFRIENDSINTERFACEIMPL));
		}
...
{
public:
	int                                                MaxSimultaneousDownloads;                         		// 0x0060 (0x0004) [0x0000000000004000] (CPF_Config)  
	...
	int                                                PendingDownloadCount;                             		// 0x00D0 (0x0004) [0x0000000000001000] (CPF_Native)  
	int                                                ActiveDownloadCount;                              		// 0x00D4 (0x0004) [0x0000000000001000] (CPF_Native)  
	int                                                SucceededDownloadCount;                           		// 0x00D8 (0x0004) [0x0000000000001000] (CPF_Native)  
	int                                                FailedDownloadCount;                              		// 0x00DC (0x0004) [0x0000000000001000] (CPF_Native)  
...
public:
	...
	unsigned char GetImageType(struct FString ContentType);
	...
	void AllValues(int StartIndex, int MaxValues, struct FOnlineImageDownload& OutImage);
	void ClearPendingDownloads();
...
public:
	...
	TArray<unsigned char>                              CachedBinaryData;                                 		// 0x0160 (0x0010) [0x0000000000400002] (CPF_Const | CPF_NeedCtorLink)
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_ONLINELOBBYINTERFACEIMPL));
		}
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_ONLINEPERSISTENTAUTHINTERFACEIMPL));
		}
	...
	void OnUnderageUserDetected(unsigned char LocalUserNum, struct FString ParentalConsentURL);
	void ClearRequestPinGrantCodeDelegate(unsigned char LocalUserNum, struct FScriptDelegate Callback);
	void AddRequestPinGrantCodeDelegate(unsigned char LocalUserNum, struct FScriptDelegate Callback);
...
public:
	...
	int                                                WorldwideTotalPlayers;                            		// 0x00B8 (0x0004) [0x0000000000000000]               
	int                                                RegionTotalPlayers;                               		// 0x00BC (0x0004) [0x0000000000000000]               
	class UOnlineTitleFileInterface*                   TitleFileInterface;                               		// 0x00C0 (0x0010) [0x0000000000002000] (CPF_Transient)
	unsigned char                                      UnknownData00[0x8];                               		// 0x00C8 (0x0008) FIX WRONG SIZE OF PREVIOUS PROPERTY
	...
	int                                                MinPlaylistIdToReport;                            		// 0x00E8 (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                CurrentPlaylistId;                                		// 0x00EC (0x0004) [0x0000000000002000] (CPF_Transient)
	struct FName                                       EventsInterfaceName;                              		// 0x00F0 (0x0008) [0x0000000000004000] (CPF_Config)  
	int                                                DataCenterId;                                     		// 0x00F8 (0x0004) [0x0000000000004000] (CPF_Config)  
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_ONLINEPURCHASEINTERFACEIMPL));
		}
...
public:
	...
	unsigned char                                      ClientBeaconState;                                		// 0x0118 (0x0001) [0x0000000000000000]               
	unsigned char                                      ClientBeaconRequestType;                          		// 0x0119 (0x0001) [0x0000000000000000]               
...
public:
	...
	int                                                NumTeams;                                         		// 0x00B8 (0x0004) [0x0000000000000002] (CPF_Const)   
	int                                                NumPlayersPerTeam;                                		// 0x00BC (0x0004) [0x0000000000000002] (CPF_Const)   
	int                                                NumReservations;                                  		// 0x00C0 (0x0004) [0x0000000000000002] (CPF_Const)   
	int                                                NumConsumedReservations;                          		// 0x00C4 (0x0004) [0x0000000000000002] (CPF_Const)   
	...
	int                                                ConnectionBacklog;                                		// 0x00E0 (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                ForceTeamNum;                                     		// 0x00E4 (0x0004) [0x0000000000000002] (CPF_Const)   
	int                                                ReservedHostTeamNum;                              		// 0x00E8 (0x0004) [0x0000000000000002] (CPF_Const)   
	unsigned long                                      bBestFitTeamAssignment : 1;                       		// 0x00EC (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned char                                      BeaconState;                                      		// 0x00F0 (0x0001) [0x0000000000000002] (CPF_Const)   
...
{
public:
	unsigned char                                      UnknownData00[0x28];                              		// 0xB1E8 (0x0028) MISSED OFFSET
public:
	static UClass* StaticClass()
	{
		static UClass* uClassPointer = nullptr;
...
public:
	...
	unsigned char                                      RequestType;                                      		// 0x00B8 (0x0001) [0x0000000000000000]               
...
{
public:
	int                                                PlaylistId;                                       		// 0x00A0 (0x0004) [0x0000000000004000] (CPF_Config)  
	...
	int                                                Priority;                                         		// 0x00C8 (0x0004) [0x0000000000004000] (CPF_Config)  
public:
	static UClass* StaticClass()
	{
		static UClass* uClassPointer = nullptr;
...
public:
	...
	int                                                ListenPort;                                       		// 0x042C (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                MaxConnections;                                   		// 0x0430 (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                DefaultApplication;                               		// 0x0434 (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                ExpirationSeconds;                                		// 0x0438 (0x0004) [0x0000000000004000] (CPF_Config)  
	...
	int                                                ConnectionCount;                                  		// 0x04A0 (0x0004) [0x0000000000000000]               
	int                                                ConnID;                                           		// 0x04A4 (0x0004) [0x0000000000000000]               
public:
	static UClass* StaticClass()
	{
		static UClass* uClassPointer = nullptr;
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                               		// 0x0258 (0x0008) FIX WRONG SIZE OF PREVIOUS PROPERTY
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_MCPMANAGEDVALUEMANAGERBASE));
		}
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_MCPMANAGEDVALUEMANAGER));
		}
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_MCPUSERINVENTORYBASE));
		}
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = reinterpret_cast<UClass*>(UObject::GObjObjects()->At(IDX_CLASS_IPDRV_MCPUSERINVENTORYMANAGER));
		}
...
public:
	...
	int                                                RawBytesExpecting;                                		// 0x030C (0x0004) [0x0000000000000000]               
	int                                                MaxValueLength;                                   		// 0x0310 (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                MaxLineLength;                                    		// 0x0314 (0x0004) [0x0000000000004000] (CPF_Config)  
	int                                                ConnID;                                           		// 0x0318 (0x0004) [0x0000000000000000]               
public:
	static UClass* StaticClass()
	{
		static UClass* uClassPointer = nullptr;
